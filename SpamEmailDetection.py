...
msg4 = '''All those sexy ladies out there. The fashion show is on....Just look hot and you will win.'''


words = word_tokenize(msg2)
features = create_word_features(words)
x = classifier.classify(features)
print("Message 2 is:", x)
